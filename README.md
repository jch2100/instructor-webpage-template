...
에이전트 채팅창에 이 문장들만 입력하면 됩니다.

| 단계 | 채팅창에 입력할 내용 |
|------|-------------------|
| 시작 | `https://github.com/jch2100/instructor-webpage-template.git 이 repo를 클론하고 폴더 안에서 작업해줘.` |
| 인터뷰 | `시작` |
| 사이트 생성 | `사이트 만들어줘` |
| 배포 | `배포 알려줘. 내 GitHub 계정은 <your-account>이고 repo 이름은 <your-repo>야.` |
